        ...
        if bus is not None and self._config.emit_events:
            bus.publish(
                KnowledgeObserved(
                    ...
                    toolmaking_knower_count=snap.toolmaking_knower_count,
                    carpentry_knower_count=snap.carpentry_knower_count,
                    ...
                    optics_knower_count=snap.optics_knower_count,
                    crystal_knower_count=snap.crystal_knower_count,
