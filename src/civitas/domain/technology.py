...
CAMP_AGRICULTURE: Technology = Technology.create(
    19,
    "Camp Agriculture",
...
CAMP_CROP_ROTATION: Technology = Technology.create(
    20,
    "Camp Crop Rotation",
    TechnologyKind.CROP_ROTATION,
    discovered=False,
    prerequisite_ids=(19,),
)
CAMP_FORESTRY: Technology = Technology.create(
    21,
    "Camp Forestry",
...
CAMP_TEXTILES: Technology = Technology.create(
    22,
    "Camp Textiles",
...
CAMP_TANNING: Technology = Technology.create(
    24,
    "Camp Tanning",
    TechnologyKind.TANNING,
    discovered=False,
    prerequisite_ids=(23,),
)
CAMP_MINING: Technology = Technology.create(
    25,
    "Camp Mining",
...
CAMP_SMITHING: Technology = Technology.create(
    26,
    "Camp Smithing",
    TechnologyKind.SMITHING,
    discovered=False,
    prerequisite_ids=(25,),
)
...
CAMP_CARPENTRY: Technology = Technology.create(
    28,
    "Camp Carpentry",
    TechnologyKind.CARPENTRY,
    discovered=False,
    prerequisite_ids=(27,),
)
CAMP_JOINERY: Technology = Technology.create(
    29,
    "Camp Joinery",
    TechnologyKind.JOINERY,
    discovered=False,
    prerequisite_ids=(28,),
)
...
CAMP_CERAMICS: Technology = Technology.create(
    31,
    "Camp Ceramics",
    TechnologyKind.CERAMICS,
    discovered=False,
    prerequisite_ids=(30,),
)
CAMP_GLAZING: Technology = Technology.create(
    32,
    "Camp Glazing",
    TechnologyKind.GLAZING,
    discovered=False,
    prerequisite_ids=(31,),
)
CAMP_PORCELAIN: Technology = Technology.create(
    33,
    "Camp Porcelain",
    TechnologyKind.PORCELAIN,
    discovered=False,
    prerequisite_ids=(32,),
)
CAMP_GLASSMAKING: Technology = Technology.create(
    34,
    "Camp Glassmaking",
    TechnologyKind.GLASSMAKING,
    discovered=False,
    prerequisite_ids=(33,),
)
CAMP_OPTICS: Technology = Technology.create(
    35,
    "Camp Optics",
    TechnologyKind.OPTICS,
    discovered=False,
    prerequisite_ids=(34,),
)
...
def census_technologies(world: World) -> TechnologyCensus:
    ...
    agriculture = sum(
        1 for tech in discovered if tech.kind is TechnologyKind.AGRICULTURE
    )
    crop_rotation = sum(
        1 for tech in discovered if tech.kind is TechnologyKind.CROP_ROTATION
    )
    ...
    ceramics = sum(1 for tech in discovered if tech.kind is TechnologyKind.CERAMICS)
    glazing = sum(1 for tech in discovered if tech.kind is TechnologyKind.GLAZING)
    porcelain = sum(1 for tech in discovered if tech.kind is TechnologyKind.PORCELAIN)
    glassmaking = sum(
    ...
    return TechnologyCensus(
        ...
        discovered_agriculture_count=agriculture,
        ...
        discovered_ceramics_count=ceramics,
        discovered_glazing_count=glazing,
