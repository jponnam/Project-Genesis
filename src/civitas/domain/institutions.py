...
and Milestone 8 academies, plus Phase 11 Milestone 3 temples and
Milestone 6 schools. Institutions are gov-attached civic organizations
with a seat location inside the government's jurisdiction, an optional
...
and schools coexist; this package seeds a single ``COUNCIL``.
