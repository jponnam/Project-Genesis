...
CAMP_CROP_ROTATION_RESEARCH: ResearchProgress = ResearchProgress.create(
    CAMP_CROP_ROTATION.technology_id.value,
    points=0,
    threshold=DEFAULT_POTTERY_THRESHOLD,
)
CAMP_FORESTRY_RESEARCH: ResearchProgress = ResearchProgress.create(
    CAMP_FORESTRY.technology_id.value,
    points=0,
    threshold=DEFAULT_POTTERY_THRESHOLD,
)
CAMP_TEXTILES_RESEARCH: ResearchProgress = ResearchProgress.create(
    CAMP_TEXTILES.technology_id.value,
    points=0,
    threshold=DEFAULT_POTTERY_THRESHOLD,
)
CAMP_DYEING_RESEARCH: ResearchProgress = ResearchProgress.create(
    CAMP_DYEING.technology_id.value,
    points=0,
    threshold=DEFAULT_POTTERY_THRESHOLD,
)
CAMP_TANNING_RESEARCH: ResearchProgress = ResearchProgress.create(
    CAMP_TANNING.technology_id.value,
    points=0,
    threshold=DEFAULT_POTTERY_THRESHOLD,
)
CAMP_MINING_RESEARCH: ResearchProgress = ResearchProgress.create(
    CAMP_MINING.technology_id.value,
    points=0,
    threshold=DEFAULT_POTTERY_THRESHOLD,
)
CAMP_SMITHING_RESEARCH: ResearchProgress = ResearchProgress.create(
    CAMP_SMITHING.technology_id.value,
    points=0,
    threshold=DEFAULT_POTTERY_THRESHOLD,
)
CAMP_TOOLMAKING_RESEARCH: ResearchProgress = ResearchProgress.create(
    CAMP_TOOLMAKING.technology_id.value,
    points=0,
    threshold=DEFAULT_POTTERY_THRESHOLD,
)
CAMP_CARPENTRY_RESEARCH: ResearchProgress = ResearchProgress.create(
    CAMP_CARPENTRY.technology_id.value,
    points=0,
    threshold=DEFAULT_POTTERY_THRESHOLD,
)
CAMP_JOINERY_RESEARCH: ResearchProgress = ResearchProgress.create(
    CAMP_JOINERY.technology_id.value,
    points=0,
    threshold=DEFAULT_POTTERY_THRESHOLD,
)
CAMP_CABINETRY_RESEARCH: ResearchProgress = ResearchProgress.create(
...
CAMP_GLAZING_RESEARCH: ResearchProgress = ResearchProgress.create(
    CAMP_GLAZING.technology_id.value,
    points=0,
    threshold=DEFAULT_POTTERY_THRESHOLD,
)
CAMP_PORCELAIN_RESEARCH: ResearchProgress = ResearchProgress.create(
    CAMP_PORCELAIN.technology_id.value,
    points=0,
    threshold=DEFAULT_POTTERY_THRESHOLD,
)
CAMP_GLASSMAKING_RESEARCH: ResearchProgress = ResearchProgress.create(
    CAMP_GLASSMAKING.technology_id.value,
    points=0,
    threshold=DEFAULT_POTTERY_THRESHOLD,
)
CAMP_OPTICS_RESEARCH: ResearchProgress = ResearchProgress.create(
    CAMP_OPTICS.technology_id.value,
    points=0,
    threshold=DEFAULT_POTTERY_THRESHOLD,
)
CAMP_CRYSTAL_RESEARCH: ResearchProgress = ResearchProgress.create(
    ...
    return tuple(
        sorted(
            (
                ...
                CAMP_GLASSMAKING_RESEARCH,
                CAMP_OPTICS_RESEARCH,
                CAMP_CRYSTAL_RESEARCH,
            ),
