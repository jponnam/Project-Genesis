...
def test_observe_emits_without_mutating_world() -> None:
    ...
    assert len(events) == 1
    assert events[0].innovation_count == 37
    ...
    assert events[0].active_loom_count == 0
    ...
    assert events[0].active_lathe_count == 0
    assert events[0].active_sawmill_count == 0
    assert events[0].active_plane_count == 0
    assert events[0].active_dovetail_count == 0
    assert events[0].active_kiln_count == 0
    assert events[0].active_glaze_count == 0
    assert events[0].active_kaolin_count == 0
    assert events[0].active_blowpipe_count == 0
    assert events[0].active_lens_count == 0
    assert events[0].active_facet_count == 0
